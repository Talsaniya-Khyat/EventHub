                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            ...
                            <h1 style="color:#003300 ; font-size:38px ;"><u><strong>Inertia</strong></u></h1><!--title-->
                            <p><!--content-->
                            ...
                            <?php $id = 1;
                            echo
                            '<a class="btn btn-default"  href="viewEvent.php?id=' . $id . '"> <span class="glyphicon glyphicon-circle-arrow-right"></span>View Inertia Events</a>'
                            ?>
                        </div><!--subcontent div-->
                    </div><!--container div-->
                </section>
            ...
            <div class="row">
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            <h1 style="color:#003300 ; font-size:38px ;"><strong><u>Controller Carnival</u></strong></h1><!--title-->
                            <p><!--content-->
                            ...
                            $id = 2;
                            echo
                            '<a class="btn btn-default" href="viewEvent.php?id=' . $id . '"> <span class="glyphicon glyphicon-circle-arrow-right"></span>View Controller Carnival Events</a>'
                            ?>
                        </div><!--subcontent div-->
                    </div><!--container div-->
                </section>
            ...
            <div class="row">
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            <h1 style="color:#003300 ; font-size:38px ;"><strong><u>Swoosh</strong></u></h1><!--title-->
                            <p><!--content-->
                            ...
                            $id = 3;
                            echo
                            '<a class="btn btn-default" href="viewEvent.php?id=' . $id . '"> <span class="glyphicon glyphicon-circle-arrow-right"></span>View Swoosh Events</a>'
                            ?>
                        </div><!--subcontent div-->
                    </div><!--container div-->
                </section>
